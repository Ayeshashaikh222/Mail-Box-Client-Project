...
const ResetPassword = () => {
  ...
  const resetPasswordSubmitHandler = (event) => {
    ...
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyAFMTuLO5f8hk5FXZ7nVuWgmVyEvaQfuEA",
      {
        method: "POST",
        body: JSON.stringify({
    ...
    <>
      ...
      <div className="flex items-center justify-center min-h-screen bg-slate-100 ">
        ...
        <div className="bg-white p-8 mx-6 rounded-lg shadow-md w-96 mb-10">
          ...
          <p className="mb-8 text-sm text-left text-blue-900">
          ...
          <form onSubmit={resetPasswordSubmitHandler}>
            ...
            <div className="flex border border-red-500">
              <div className="text-left flex gap-2 text-xs text-blue-900 mr-2">
